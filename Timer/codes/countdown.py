...
window.title("Swetha's Countdown timer and notification")

#activate timer and show notifications once timer is up
def timer(): 
...
title_label_1 = Label(window, text="Swetha's Countdown timer with notification",font=("Gayathri", 11)).pack()
